...
/*Date		: 26-sept-2019	*/
/*Filename	: search_sort_doubly_list.c*/
/*Description	: source file for linear search,bubble sort in doubly linked list*/
/*********************************************************************************/

/* Included header files */
#include "search_sort_doubly_list.h"
...
int main()
{
	...
	printf("Bubble Sort doubly linked list :\n");
	display(&head);
	return 0;
}
